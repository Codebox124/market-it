          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  We <span className="font-medium text-white">create</span>{" "}
                  exceptional visual content and
                  <span className="font-medium text-white">
                    {" "}
                    strategically market
                  </span>{" "}
                  for businesses, artists, and visionaries. Our comprehensive
                  services span graphic design, photography, videography, web
                  development, animation, and digital marketing—transforming
                  ideas into compelling visual narratives that captivate and
                  convert.
                </motion.p>
              </div>
            </motion.div>
